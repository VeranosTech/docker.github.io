...
<div class="component-container">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-4 block">
            <div class="component">
                <div class="component-icon">
                    <a href="{{ site.baseurl }}/docker-for-mac/"> <img src="..{{ site.baseurl }}/images/apple_48.svg" alt="Docker for Mac"> </a>
                </div>
                <h3 id="docker-for-mac"><a href="{{ site.baseurl }}/docker-for-mac/">Docker for Mac</a></h3>
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 block">
            <div class="component">
                <div class="component-icon">
                    <a href="{{ site.baseurl }}/docker-for-windows/"> <img src="..{{ site.baseurl }}/images/windows_48.svg" alt="Docker for Windows"> </a>
                </div>
                <h3 id="docker-for-windows"><a href="{{ site.baseurl }}/docker-for-windows/">Docker for Windows</a></h3>
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 block">
            <div class="component">
                <div class="component-icon">
                    <a href="{{ site.baseurl }}/engine/installation/linux/ubuntu/"> <img src="..{{ site.baseurl }}/images/linux_48.svg" alt="Docker for Linux"> </a>
                </div>
                <h3 id="docker-for-linux"><a href="{{ site.baseurl }}/engine/installation/linux/ubuntu/">Docker for Linux</a></h3>
...
<div class="component-container">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-4 block">
            <div class="component">
                <div class="component-icon">
                    <a href="{{ site.baseurl }}/docker-cloud/"> <img src="..{{ site.baseurl }}/images/cloud_48.svg" alt="Docker Cloud"> </a>
                </div>
                <h3 id="docker-cloud"><a href="{{ site.baseurl }}/docker-cloud/">Docker Cloud</a></h3>
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 block">
            <div class="component">
                <div class="component-icon">
                    <a href="{{ site.baseurl }}/docker-for-aws/"> <img src="..{{ site.baseurl }}/images/cloud_48.svg" alt="Docker for AWS"> </a>
                </div>
                <h3 id="docker-cloud-providers"><a href="{{ site.baseurl }}/docker-for-aws/">Docker for AWS</a></h3>
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 block">
            <div class="component">
                <div class="component-icon">
                    <a href="{{ site.baseurl }}/docker-for-azure/"> <img src="..{{ site.baseurl }}/images/cloud_48.svg" alt="Docker for Azure"> </a>
                </div>
                <h3 id="docker-cloud-providers"><a href="{{ site.baseurl }}/docker-for-azure/">Docker for Azure</a></h3>
...
<div class="component-container">
    ...
    <!--UCP-->
        <div class="col-sm-12 col-md-12 col-lg-4 block">
            <div class="component">
                <div class="component-icon">
                    <a href="{{ site.baseurl }}/datacenter/ucp/{{ site.ucp_version }}/guides/"> <img src="..{{ site.baseurl }}/images/UCP_48.svg" alt="Universal Control Plane"> </a>
                </div>
                <h3 id="ucp"><a href="{{ site.baseurl }}/datacenter/ucp/{{ site.ucp_version }}/guides/">Universal Control Plane</a></h3>
    ...
    <!--DTR-->
        <div class="col-sm-12 col-md-12 col-lg-4 block">
            <div class="component">
                <div class="component-icon">
                    <a href="{{ site.baseurl }}/datacenter/dtr/{{ site.dtr_version }}/guides/"> <img src="..{{ site.baseurl }}/images/dtr_48.svg" alt="Docker Trusted Registry"> </a>
                </div>
                <h3 id="dtr"><a href="{{ site.baseurl }}/datacenter/dtr/{{ site.dtr_version }}/guides/">Docker Trusted Registry</a></h3>
...
<div class="component-container">
    ...
    <!--compose-->
        <div class="col-sm-12 col-md-12 col-lg-4 block">
            <div class="component">
                <div class="component-icon">
                    <a href="{{ site.baseurl }}/compose/overview/"> <img src="..{{ site.baseurl }}/images/compose_48.svg" alt="Docker Compose"> </a>
                </div>
                <h3 id="compose"><a href="{{ site.baseurl }}/compose/overview/">Docker Compose</a></h3>
    ...
    <!--machine-->
        <div class="col-sm-12 col-md-12 col-lg-4 block">
            <div class="component">
                <div class="component-icon">
                    <a href="{{ site.baseurl }}/machine/overview/"> <img src="..{{ site.baseurl }}/images/machine_48.svg" alt="Docker Trusted Registry"> </a>
                </div>
                <h3 id="machine"><a href="{{ site.baseurl }}/machine/overview/">Docker Machine</a></h3>
